setwd("C:/Users/sprab/OneDrive/Documents/Study/University/AP/Presentation 2/Quartile")
...
apollo_control=list(modelName  ="QuartileModel",
                    modelDescr ="Quartile",
                    indivID    ="Driver_tag",
                    workInLogs = TRUE,
...
Base.2 = apollo_estimate(apollo_beta,
                         apollo_fixed,
                         apollo_probabilities,
                         apollo_inputs)

apollo_modelOutput(Base.2)
apollo_saveOutput(Base.2)
...
head(Base.2$avgCP,13)

forecast <- apollo_prediction(Base.2, apollo_probabilities, apollo_inputs, prediction_settings = list(runs=30))
