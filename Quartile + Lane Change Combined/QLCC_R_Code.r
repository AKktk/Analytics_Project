setwd("C:/Users/sprab/OneDrive/Documents/Study/University/AP/Presentation 2/Quartile + Lane Change Combined")
...
apollo_control=list(modelName  ="QLCCModel",
                    modelDescr ="Quartile and Lane Change combi",
                    indivID    ="Driver_tag",
                    workInLogs = TRUE,
...
forecast <- apollo_prediction(Base.0, apollo_probabilities, apollo_inputs)
hist(forecast$at_estimates$chosen)

write.csv(forecast,'C:/Users/sprab/OneDrive/Documents/Study/University/AP/Presentation 2/Quartile + Lane Change Combined',row.names = FALSE)